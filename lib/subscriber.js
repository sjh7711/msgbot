...
//
// ⚠ require() 경로 미확인:
//   이 모듈을 require() 하는 디바이스측 절대경로가 아직 확인되지 않았다.
//   MessengerBot R(RhinoJS/GraalJS) 의 require() 해석 규칙과 lib 폴더
//   실제 위치는 태블릿에서 직접 검증해야 한다. 검증 전까지는 eval.js
//   프로토타입에만 연결하고 나머지 봇은 인라인 보일러플레이트를 유지한다.
//
// 사용:
