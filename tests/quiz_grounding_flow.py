...
class JavaScriptGroundingContractTests(unittest.TestCase):
    ...
    def test_javascript_grounding_contract(self) -> None:
        ...
        required = (
            ...
            "shouldRetrySameQuizMaterial",
            "var materialIndex = 0;",
            "var sameMaterialRetryUsed = false;",
            "verified_distractors",
            "verified_answer_aliases",
            "verifiedMaterialAliasNames",
            "_verifiedAliasEntries",
        ...
        for snippet in (
            ...
            "material.answer_aliases",
            "GROUNDED_ALIAS_KINDS",
            "SYNTHETIC_ALIAS_KINDS",
            ...
            'conn.setRequestProperty("X-Gemini-API-Key", clientGeminiKey)',
            '"X-Gemini-Key-Stored"',
            '"X-Gemini-Key-Pool-Size"',
            '"X-Gemini-Credential-Source"',
            "payload.code",
            '"MODEL_OUTPUT_FORMAT"',
            '"TOPIC_NOT_FOUND"',
        ):
        ...
        for code in (
            ...
            "GEMINI_API_KEY_REQUIRED",
            "CLIENT_GEMINI_QUOTA_EXHAUSTED",
            "CLIENT_GEMINI_KEYS_INVALID",
            "INVALID_CLIENT_GEMINI_KEY",
        ):
            self.assertIn(
                f'evidenceCode === "{code}"',
                source,
